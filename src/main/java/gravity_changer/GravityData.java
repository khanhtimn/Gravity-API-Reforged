 ...
 */
public class GravityData implements Component, AutoSyncedComponent, CommonTickingComponent {
    ...
    private @Nullable GravityData.GravityDirEffect delayApplyDirEffect = null;
