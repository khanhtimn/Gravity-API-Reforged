 ...
 */
public class GravityComponentFabric implements Component, AutoSyncedComponent, CommonTickingComponent {
    
    public static interface GravityUpdateCallback {
        void update(Entity entity, GravityComponentFabric component);
    }
     ...
     * {@link GravityComponentFabric#applyGravityDirectionEffect(Direction, RotationParameters, double)}
     * and
     * {@link GravityComponentFabric#applyGravityStrengthEffect(double)}
    ...
    private @Nullable GravityComponentFabric.GravityDirEffect delayApplyDirEffect = null;
    ...
    public GravityComponentFabric(Entity entity) {
        this.entity = entity;
