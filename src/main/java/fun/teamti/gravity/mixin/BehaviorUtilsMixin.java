...
public class BehaviorUtilsMixin {
    ...
    private static ItemEntity onInitItemEntity(
        ...
        ItemEntity itemEntity = operation.call(level, itemPos.x(), itemPos.y(), itemPos.z(), itemStack);
        GravityAPI.setBaseGravityDirection(itemEntity, GravityAPI.getGravityDirection(entity));
        return itemEntity;
    }
    ...
    private static void onSetDeltaMovement(
        ...
        GravityAPI.setWorldVelocity(entity, deltaMovement);
    }
